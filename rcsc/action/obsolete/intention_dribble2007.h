...
#ifndef RCSC_ACTION_INTENTION_DRIBBLE_2007_H
#define RCSC_ACTION_INTENTION_DRIBBLE_2007_H
...
public:
     ...
     */
    IntentionDribble2007( const Vector2D & target_point,
