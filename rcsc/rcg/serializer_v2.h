...
/*!
  ...
  \brief v2 format serializer class Header File.
*/
...
#ifndef RCSC_RCG_SERIALIZER_V2_H
#define RCSC_RCG_SERIALIZER_V2_H
...
/*!
  \class SerializerV2
  \brief v2 format rcg data serializer interface class
*/
class SerializerV2
    : public Serializer {
private:
